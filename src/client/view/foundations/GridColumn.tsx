...
const GridColumn = ({
  ...
  const GridColumnStyled = styled.div({
    ...
    [theme.media.medium]: {
      ...
      ...(realSizeMedium
        ? {
            width: `calc(100% / (12/${realSizeMedium}))`,
            flexBasis: `calc(100% / (12/${realSizeMedium}))`,
            maxWidth: `calc(100% / (12/${realSizeMedium}))`
          }
        : {}),
    ...
    [theme.media.large]: {
      ...
      ...(realSizeLarge
        ? {
            width: `calc(100% / (12/${realSizeLarge}))`,
            flexBasis: `calc(100% / (12/${realSizeLarge}))`,
            maxWidth: `calc(100% / (12/${realSizeLarge}))`
          }
        : {}),
    ...
    [theme.media.huge]: {
      ...
      ...(realSizeHuge
        ? {
            width: `calc(100% / (12/${realSizeHuge}))`,
            flexBasis: `calc(100% / (12/${realSizeHuge}))`,
            maxWidth: `calc(100% / (12/${realSizeHuge}))`
          }
        : {}),
